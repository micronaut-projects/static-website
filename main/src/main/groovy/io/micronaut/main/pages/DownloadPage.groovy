...
class DownloadPage extends Page {
    ...
    GuideGroup downloadGuideGroup() {
        ...
        new GuideGroup(title: "Download ${micronaut()} ${latestVersion}",
                ...
                //description: 'Select a profile and set of features tailored to your needs with our application initializer, Micronaut Application Forge',
                items: [
//                        new GuideGroupItem(href: "http://start.micronaut.io", title: 'Micronaut Application Forge'),
    ...
    String mainContent() {
        ...
        html.div(class: 'content container') {
            ...
            h2 {
                'We will release first milestone next week. Stay tuned!'
            }
...
//                            mkp.yield ' to download and configure any Micronaut version of your choice. Basic '
