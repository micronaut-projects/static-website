    ...
    fetch(FETCH_URL, {
      ...
      .catch(response => {
        ...
        response.json().then(body => {
          this.setState({error: true, errorMessage: body.message, downloading: false});
        })
      });
  };
        ...
        <div className="mn-main-container sticky">
          <div className="container">
            ...
            <div className="mn-container">
              {this.state.error ? (
                  <h5 style={{ color: "red", paddingLeft: "20px" }}>Something went wrong: {this.state.errorMessage}</h5>
              ) : null}
